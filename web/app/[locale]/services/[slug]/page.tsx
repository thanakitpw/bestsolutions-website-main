...
const PROCESS_STEPS_BY_SLUG: Record<string, ProcessStep[]> = {
  ...
  "paid-ads": [
    ...
    { num: "02", total: "04", duration: "1 WEEK", title: "เตรียมครีเอทีฟและเริ่มแคมเปญ", description: "เตรียมชุดข้อความ ภาพ หรือวิดีโอสำหรับทดสอบ แล้วเริ่มเก็บข้อมูลจากแคมเปญจริง", icon: ICON_SVG },
  ...
  production: [
    { num: "01", total: "04", duration: "1 WEEK", title: "วาง concept และ script", description: "สรุปเป้าหมายของวิดีโอ กลุ่มผู้ชม และแกนเรื่อง ก่อนวาง script หรือ storyboard", icon: ICON_SVG },
    { num: "02", total: "04", duration: "1-2 DAYS", title: "ถ่ายทำ", description: "จัดทีมและถ่ายทำตามแผนที่ตกลงไว้ โดยคุมภาพ เสียง และรายละเอียดสำคัญของแบรนด์", icon: ICON_SVG },
    { num: "03", total: "04", duration: "1-2 WEEKS", title: "ตัดต่อและเก็บรายละเอียด", description: "ตัดต่อ ปรับสี เสียง ใส่ caption และจัดเวอร์ชันให้เหมาะกับช่องทางใช้งาน", icon: ICON_SVG },
    { num: "04", total: "04", duration: "1 WEEK", title: "ส่งมอบไฟล์พร้อมใช้งาน", description: "ส่งมอบไฟล์หลักและเวอร์ชันสำหรับแพลตฟอร์มต่าง ๆ เช่น Facebook, Instagram, TikTok หรือ YouTube", icon: ICON_SVG },
  ],
};
...
const FAQS_BY_SLUG: Record<string, FAQItem[]> = {
  ...
  production: [
    { q: "ราคาวิดีโอเริ่มต้นเท่าไหร่?", a: "ราคาขึ้นกับรูปแบบวิดีโอ จำนวนวันถ่ายทำ ทีมงาน สถานที่ และขอบเขตการตัดต่อ เล่าโจทย์มาก่อนได้ แล้วเราจะช่วยประเมินให้เหมาะกับงบ" },
    { q: "ใช้เวลาผลิตนานแค่ไหน?", a: "ขึ้นกับรูปแบบงานและจำนวนชิ้น โดยทั่วไปเริ่มจากวาง concept ถ่ายทำ ตัดต่อ และตรวจแก้ตามรอบที่ตกลงกัน" },
    { q: "ถ่ายทำต่างจังหวัดได้ไหม?", a: "ได้ สามารถประเมินค่าเดินทาง ทีมงาน และ logistics เพิ่มเติมตามสถานที่และรูปแบบงาน" },
    { q: "ส่งมอบไฟล์รูปแบบไหน?", a: "ส่งมอบไฟล์ตามช่องทางที่ต้องใช้ เช่น แนวนอน แนวตั้ง หรือสี่เหลี่ยม พร้อมขนาดที่เหมาะกับแพลตฟอร์มหลัก" },
    { q: "แก้งานได้กี่รอบ?", a: "จำนวนรอบแก้จะระบุในขอบเขตงานก่อนเริ่ม เพื่อให้ทีมและลูกค้าเข้าใจตรงกันว่าการแก้ไขครอบคลุมส่วนใดบ้าง" },
  ],
};
